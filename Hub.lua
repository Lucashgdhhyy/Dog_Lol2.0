-- Why you are reading my code?

local ArrayField = loadstring(game:HttpGet('https://raw.githubusercontent.com/Lucashgdhhyy/Dog_Lol2.0/refs/heads/main/arrayfield/arrayfield.lua'))()
local Window = ArrayField:CreateWindow({
   Name = "Dog_Lol | @dog_lolhub",
   LoadingTitle = "Key Carregada!",
   LoadingSubtitle = "by durk7896",
   ConfigurationSaving = {
      Enabled = true,
      FolderName = nil, -- Create a custom folder for your hub/game
      FileName = "doglolfoldersaves"
   },
   Discord = {
      Enabled = false,
   ...
   KeySettings = {
      ...
      Subtitle = "Key System",
      Note = "Key System",
      FileName = "doglolfolder2", -- It is recommended to use something unique as other scripts using ArrayField may overwrite your key file
      ...
      Actions = {
            [1] = {
                Text = 'Click here for copy the key <---,
                OnPress = function()  setclipboard("https://rkns.link/xgbkl")
                end,
                }
            },
