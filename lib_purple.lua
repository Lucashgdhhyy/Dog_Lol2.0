...
local OrionLib = {
	...
	Themes = {
		Default = {
      Main = Color3.fromRGB(50, 0, 75),      -- Fundo principal em um tom roxo escuro
Second = Color3.fromRGB(75, 0, 100),   -- Fundo secundário com um tom roxo mais claro
Stroke = Color3.fromRGB(90, 0, 120),   -- Contorno em um tom roxo médio
Divider = Color3.fromRGB(120, 0, 150), -- Linha divisora em um tom roxo vibrante
Text = Color3.fromRGB(200, 150, 255),  -- Texto em um tom roxo claro
TextDark = Color3.fromRGB(120, 75, 160) -- Texto escuro em um tom roxo acinzentado
		}
	},
